...
public class Customer implements Runnable {
    ...
    public Customer(/*customerNum = threadNum*/int customerNum, /*From Main, Customer.maxDemand = main.maxDemand*/int[] maxDemand, Bank theBank) {
        ...
        //I think I pass this line into Bank; request[] = BankImpl.allocated[]
        ...
        while (canRun) {
            try {
                ...
                if (theBank.requestResources(customerNum, request)) {   // if customer can proceed
                    ...
                    /*canRun =*/ theBank.releaseResources(customerNum, request);
                }
            } catch (InterruptedException ie) { canRun = false; }


        }
        if (canRun == false) System.out.println("Customer Finished.");
        else System.out.println("Thread # " + customerNum + " I'm interrupted.");
    }
